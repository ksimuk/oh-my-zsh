...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/MaximKraev/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/MaximKraev/oh-my-zsh/master/tools/install.sh -O -)"
```
...
# see https://github.com/MaximKraev/oh-my-zsh/wiki/Themes#agnoster
```
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/MaximKraev/oh-my-zsh/master/tools/install.sh)"
```
